...
class SettingsController extends Controller
{
    ...
    public function nftSettings()
    {
        ...
        $data['title'] = __('NFT Settings');
        $data['settings'] = allsetting();
        return view('admin.settings.nft', $data);
    }

    public function moralisUpdate(Request $request)
    {
        $env_val['MORALIS_SERVER_URL'] = $request->moralis_server_url;
        $env_val['MORALIS_APPLICATION_ID'] = $request->moralis_application_id;
        $env_val['CONTRACT_ADDRESS'] = $request->contact_address;
        $env_val['ADMIN_ADDRESS'] = $request->admin_address;
        $env_val['FEE_PERCENT'] = $request->fee_percent;
        $env_val['CHAIN'] = $request->chain;
        $env_val['EXPLORER_URL'] = $request->explorer_url;
