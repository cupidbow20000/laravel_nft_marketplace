...
Route::group(['prefix'=>'admin','namespace'=>'admin','middleware'=> ['auth','admin']],function () {
    ...
    Route::get('nft-settings', 'SettingsController@nftSettings')->name('admin_nft_settings');
    Route::post('moralis-update', 'SettingsController@moralisUpdate')->name('admin_moralis_update');
