...
Route::post('auth-check', 'AuthController@authCheck')->name('auth_check');
...
Route::get('/contact-address-list', 'PageController@contactAddressList')->name('contact_address_list');
Route::get('/product/view/{id}', 'PageController@productView')->name('product_view');
Route::get('/nft-details/{token_address}/{token_id}', 'PageController@nftDetails')->name('nft_details');
Route::post('/ajax-nft-details', 'PageController@ajaxNFTDetails')->name('ajax_nft_details');
...
Route::get('admin/login', 'AuthController@adminLogin')->name('admin_login');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('logout-admin', 'AuthController@logoutAdmin')->name('admin_logout');
});
