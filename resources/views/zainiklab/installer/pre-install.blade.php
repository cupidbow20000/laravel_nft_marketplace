        ...
        <div class="row">
            ...
            <div class="col-6">
                <form action="{{ route('ZaiInstaller::server-validation') }}" method="post">
                    @csrf
                    <input type="hidden" name="routes" value="{{ File::exists(base_path('routes'))  ? 1 : 0 }}">
                    <input type="hidden" name="resources" value="{{ File::exists(base_path('resources'))   ? 1 : 0 }}">
                    <input type="hidden" name="public" value="{{ File::exists(base_path('public'))  ? 1 : 0 }}">
                    <input type="hidden" name="storage" value="{{ File::exists(base_path('storage'))  ? 1 : 0 }}">
                    <input type="hidden" name="env" value="{{ File::exists(base_path('.env'))  ? 1 : 0 }}">
