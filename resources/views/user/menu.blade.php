                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu {{session()->has('lang_dir') && session()->get('lang_dir') == 'rtl' ? 'direction-rtl dropdown-menu-left' : 'dropdown-menu-right'}}" aria-labelledby="userNavbarDropdown">
                                    <div class="navbarUserDropdownInner d-flex align-items-center">
                                        ...
                                        <div class="navbar-user-name font-semi-bold font-18 ieSfBq iwpzju" aria-expanded="false">
                                            <button type="button" class="dCGfAr eehqFj vsAto" >
                                                <div class="fCODes dqnTGd">
                                                    <div class="HTkSN dqnTGd kGfXVs">
                                                        <div class="jcBDFG dqnTGd">
                                                            <div class="cHEsYJ dqnTGd">
                                                                <span class="cKGsVP hkiAcU my-eth-address" onclick="copyToClipboard('#my-eth-address')">0x17AEA4e17...0eE6</span>
                                                                <input type="hidden" id="my-eth-address">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
{{--                                    <a href="{{route('my_wallets')}}" class="dropdown-item theme-button1 user-dropdown-nav-wallet">{{__('main.My-Wallet')}}</a>--}}
                                    <div class="wallet-connected-after-login p-3">
                                        <div class="balance-show-inside-wallet d-flex align-items-center">
                                            <i class="fab fa-ethereum"></i>
                                            <div class="text-left">
                                                <span>{{__('main.Balance')}}</span>
                                                <h5><span class="show-blanace"></span> {{__('ETH')}}</h5>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Show If Wallet not connected after login -->
...
{{--                                    <div class="dropdown-divider"></div>--}}
                                    ...
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" onclick="logout()" ><i class="fas fa-sign-in-alt"></i>{{__('main.Logout')}}</a>
                                </div>
                            </li>
                        @else
                                ...
                                <span class="navbar-user-img-wrap position-relative">
                                    ...
                                    <div class="dropdown-menu {{session()->has('lang_dir') && session()->get('lang_dir') == 'rtl' ? 'direction-rtl dropdown-menu-left' : 'dropdown-menu-right'}}" aria-labelledby="userNavbarDropdown1">
                                        <div class="navbarUserDropdownInner d-flex align-items-center">
                                            ...
                                            <div class="ieSfBq iwpzju" aria-expanded="false">
                                                <button type="button" class="dCGfAr eehqFj vsAto" >
                                                    <div class="fCODes dqnTGd">
                                                        <div class="HTkSN dqnTGd kGfXVs">
                                                            <div class="jcBDFG dqnTGd">
...
{{--                                            <button type="button" class="dCGfAr eehqFj vsAto" >--}}
{{--                                                <div class="fCODes dqnTGd">--}}
{{--                                                    <div class=" fyMefh dqnTGd ficglT">--}}
{{--                                                        <img alt="ETH" src="{{asset('assets/user/img/eth.svg')}}"  class="dIclzb QejWU">--}}
{{--                                                    </div>--}}
{{--                                                    <div class="HTkSN dqnTGd kGfXVs">--}}
{{--                                                        <div class="jcBDFG dqnTGd">--}}
{{--                                                            <div class="cHEsYJ dqnTGd">--}}
...
{{--                                        <a class="dropdown-item" href="{{route('login')}}"><i class="fas fa-tachometer-alt"></i>{{__('main.Dashboard')}}</a>--}}
                                        ...
                                        <a class="dropdown-item" href="{{route('my_collections')}}"><i class="far fa-image"></i>{{__('main.My-Artworks')}}</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" onclick="logout();"><i class="fas fa-sign-in-alt"></i>{{__('main.Disconnect')}}</a>
                                    </div>
                                </li>
                                <!-- If isLoginMenu Then Show Menu User Box -->
                        @endif
