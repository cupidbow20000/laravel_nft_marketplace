    ...
    <div class="search-rightside-area">
        <div class="artists-nav-wrap d-flex justify-content-between">
            <ul class="nav nav-tabs tab-nav-list border-0" role="tablist">
                <li class="nav-item">
                    <a class="nav-link {{Route::is('user_profile') ? 'active' : '' }}" data-toggle="tab" href="#On_sale" role="tab">{{__('main.on sales')}}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{Route::is('my_collections') ? 'active' : '' }}" data-toggle="tab" href="#Collectibles" role="tab">{{__('main.Collectibles')}}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#Created" role="tab">{{__('main.Draft')}}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#Like" role="tab">{{__('main.Like')}}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#Following" role="tab">{{__('main.Following')}}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#Followers" role="tab">{{__('main.Followers')}}</a>
                </li>
            </ul>
            ...
            <div class="top-artist-warp tab-pane {{Route::is('user_profile') ? 'active show' : ''}}" id="On_sale" role="tabpanel">
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <button class="load-more-btn theme-button2 mt-3" id="load-more-sale" data-paginate="2">{{__('main.Load More')}}</button>
                    </div>
                </div>
            </div>
...
{{--                <div class="row">--}}
{{--                    <div class="col-12 text-center">--}}
{{--                        <button class="load-more-btn theme-button2 mt-3" id="load-more" data-paginate="2">{{__('main.Load More')}}</button>--}}
{{--                    </div>--}}
{{--                </div>--}}
            </div>
            ...
            <div class="top-artist-warp fade tab-pane" id="Created" role="tabpanel">
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <button class="load-more-btn theme-button2 mt-3" id="load-more-created" data-paginate="2">{{__('main.Load More')}}</button>
                    </div>
                </div>
            </div>
            ...
            <div class="top-artist-warp fade tab-pane" id="Like" role="tabpanel">
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <button class="load-more-btn theme-button2 mt-3" id="load-more-like" data-paginate="2">{{__('main.Load More')}}</button>
                    </div>
                </div>
            </div>
            <div class="top-artist-warp following-tab-wrap fade tab-pane" id="Following" role="tabpanel">
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <button class="load-more-btn theme-button2 mt-3" id="load-more-following" data-paginate="2">{{__('main.Load More')}}</button>
                    </div>
                </div>
            </div>
            <div class="top-artist-warp following-tab-wrap fade tab-pane" id="Followers" role="tabpanel">
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <button class="load-more-btn theme-button2 mt-3" id="load-more-follower" data-paginate="2">{{__('main.Load More')}}</button>
                    </div>
                </div>
            </div>
        </div>
...
<input type="hidden" value="{{route('my_nft_collections')}}" id="my-nft-collections">
