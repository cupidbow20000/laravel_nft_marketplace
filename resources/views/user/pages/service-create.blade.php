...
@section('content')
    ...
    <section class="create-new-page-area section-t-space">
        <div class="container">
            {{Form::open(['route' => 'service_store', 'files' => true, 'data-handler'=>"showMessage" ,'class' => 'nft-create-ajax'])}}
                <div class="row">
                                ...
                                <div class="common-radio d-flex align-items-center">
                                    ...
                                    <div class="radiobox-wrap">
                                        <label class="custom-radio" for="type1">
                                            <input id="type1" type="radio" name="type" value="{{FIXED_PRICE}}" checked>
...
{{--                                    </div>--}}
{{--                                </div>--}}
                                <input type="hidden" value="5000" id="price_dollar" name="price_dollar">
...
{{--                                </div>--}}
                        ...
                        <div class="create-new-page-box">
                            ...
                            <div class="form-group custom-file-upload">
                                <div class="custom-file">
                                    <input type="file" required class="custom-file-input putImage1" id="nft-minting-file" name="thumbnail">
                                    <label class="custom-file-label" for="nft-minting-file">
    ...
    <div class='modal fade common-modal purchase-inner-modal' id='mintProcessModal' data-backdrop='static' data-keyboard='false' tabindex='-1' aria-labelledby='mintProcessModalLabel' aria-hidden='true'>
        <div class='modal-dialog modal-dialog-centered'>
            <div class='modal-content'>
                <div class='modal-header p-0'>
                    <h4 class='modal-title' id='mintProcessModalLabel'>Follow Steps</h4>
                    </div>
                <div class='modal-body p-0'>
                    <div class='change-price-box checkout-content-box'>
                        ...
                        <div id='mint-txt'></div>
                        <div id='db-txt'></div>
                        <div class='preview-inner-modal-btn' id='go-my-artworks'>
                            <button class='theme-button2 w-100 mt-0'>Processing</button>
                        </div>
                    </div>
                </div>
            </div>
