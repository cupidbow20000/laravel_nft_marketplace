                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 mt-20">
                                            <div class="single-uplode">
                                                ...
                                                <small class="text-success">{{__('* Logo size will be 74px * 20px')}}</small>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 mt-20">
                                            <div class="single-uplode">
                                                <div class="uplode-catagory">
                                                    <span>{{__('Admin Panel Logo')}}</span>
                                                </div>
                                                <div class="form-group buy_coin_address_input ">
                                                    <div id="file-upload" class="section-p">
                                                ...
                                                <small class="text-success">{{__('* Admin Panel Logo size will be 72px * 72px')}}</small>
                                        ...
                                        <div class="col-lg-6 mt-20">
                                            <div class="single-uplode">
                                                ...
                                                <small class="text-success">{{__('* Favicon size will be 16px * 16px')}}</small>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 mt-20">
                                            <div class="single-uplode">
                                                <div class="uplode-catagory">
                                                    <span>{{__('User Panel Banner')}}</span>
                                                </div>
                                                <div class="form-group buy_coin_address_input ">
                                                    <div id="file-upload" class="section-p">
                                                ...
                                                <small class="text-success">{{__('* Logo size will be 1600px * 332px')}}</small>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 mt-20">
                                            <div class="single-uplode">
                                                <div class="uplode-catagory">
                                                    <span>{{__('Preloader Icon')}}</span>
                                                </div>
                                                <div class="form-group buy_coin_address_input ">
                                                    <div id="file-upload" class="section-p">
                                                        <input type="file" placeholder="0.00" name="preloader_logo"
                                                               id="file" ref="file" class="dropify"
                                                               @if(isset($settings['preloader_logo']) && (!empty($settings['preloader_logo'])))  data-default-file="{{asset(path_image().$settings['preloader_logo'])}}" @endif />
                                                    </div>
                                                </div>

                                                <div class="form-group admin-inner-pages-thumb">
                                                    <img src="{{asset(path_image().$settings['preloader_logo'])}}" alt="img" class="img-fluid">
                                                </div>
                                                <small class="text-success">{{__('* Preloader size will be 72px * 72px')}}</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
